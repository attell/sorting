var questions = [
    ["Which of the following is not a stable sorting algorithm in its typical implementation?", "Insertion Sort",
     "Bubble Sort", "Quick Sort","Merge Sort", "3"],
    ["Consider a situation where swap operation is very costly. Which of the following sorting algorithms should be preferred so that the number of swap operations are minimized in general?", 
    "Heap Sort", "Selection Sort", "Insertion Sort", "Merge Sort","2"],
    ["You have to sort 1 GB of data with only 100 MB of available main memory. Which sorting technique will be most appropriate?",
     "Merge Sort", "Heap Sort", "Insertion Sort", "all","1"],
    ["What is the worst case time complexity of insertion sort where position of the data to be inserted is calculated using binary search?",
     " N", " NlogN", "N^2", "None of these","3"],
    ...
    "Bubble Sort", " Insertion Sort", "Heap Sort", "Merge Sort","2"],
    ["Which of the below given sorting techniques has highest best-case runtime complexity.", 
    "Quick Sort", "Insertion Sort", "Bubble Sort", "Selectio Sort","4"],
    ...
    ["Assume that we use Bubble Sort to sort n distinct elements in ascending order. When does the best case of Bubble Sort occur?",
     "When elements are sorted in ascending order", "When elements are sorted in descending order", "When elements are not sorted by any order", 
     "None of these","1"],
    ...
    "4 3 2 1 5 3 2 1 5 4 2 1 5 4 3 1 5 4 3 2",
     "4 5 3 2 1 2 3 4 5 1 3 4 5 2 1 1 2 3 4 5","1"],
    ];